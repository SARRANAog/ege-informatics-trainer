...
export default function PracticePage() {
    ...
    return (
        <div className="grid gap-6 xl:grid-cols-[300px_minmax(0,1fr)]">
            <aside className="h-fit rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
                <div className="px-2 pb-3">
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-400">
                        Теоретические задания идут только через выбор ответа. Кодовые задания
                        идут через ручной ввод решения на Python.
                    </p>
                </div>
            ...
            <main>
                <PracticeTaskView taskId={selectedTaskId} questions={practiceQuestions} />
            </main>
        </div>
    );
}
